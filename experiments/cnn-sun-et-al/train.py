...
def main(args):
    ...
    train_df= pd.read_csv("datasets/sharp_sun_et_al/sharp_sun_et_al_df_train_balanced_v3.csv")
    valid_df= pd.read_csv("datasets/sharp_sun_et_al/sharp_sun_et_al_df_val_balanced_v3.csv")
    test_df= pd.read_csv("datasets/sharp_sun_et_al/sharp_sun_et_al_df_test_balanced_v3.csv")
    ...
    wandb.config.update({
        "train_data":"datasets/sharp_sun_et_al/sharp_sun_et_al_df_train_balanced_v3.csv",
        "validation_data":"datasets/sharp_sun_et_al/sharp_sun_et_al_df_val_balanced_v3.csv",
        "test_data":"datasets/sharp_sun_et_al/sharp_sun_et_al_df_test_balanced_v3.csv"
    })
