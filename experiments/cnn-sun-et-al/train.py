...
def main(args):
    ...
    train_df= pd.read_csv("datasets/sharp_sun_et_al/v4/sharp_sun_et_al_df_train_balanced_v4.csv")
    valid_df= pd.read_csv("datasets/sharp_sun_et_al/v4/sharp_sun_et_al_df_val_balanced_v4.csv")
    test_df= pd.read_csv("datasets/sharp_sun_et_al/v4/sharp_sun_et_al_df_test_balanced_v4.csv")
    ...
    wandb.config.update({
        "train_data":"datasets/sharp_sun_et_al/v4/sharp_sun_et_al_df_train_balanced_v4.csv",
        "validation_data":"datasets/sharp_sun_et_al/v4/sharp_sun_et_al_df_val_balanced_v4.csv",
        "test_data":"datasets/sharp_sun_et_al/v4/sharp_sun_et_al_df_test_balanced_v4.csv"
    })
